...
void SimulationSystem::write_output(size_t run, const std::string &add) {
	...
	for (size_t i = 0; i < error_acc.size(); i++) {
		...
		double mean_lq    = error_acc[i].err[1].mean();
		double mean_gth   = error_acc[i].err[2].mean();
		double mean_power = error_acc[i].err[3].mean();
		double mean_other = error_acc[i].err[4].mean();
		double mean_q     = error_acc[i].err[5].mean();
		double var_lq     = error_acc[i].err[1].variance();
		double var_gth    = error_acc[i].err[2].variance();
		double var_power  = error_acc[i].err[3].variance();
		double var_other  = error_acc[i].err[4].variance();
		double var_q      = error_acc[i].err[5].variance();
		size_t cnt_lq     = error_acc[i].err[1].count();
		size_t cnt_gth    = error_acc[i].err[2].count();
		size_t cnt_power  = error_acc[i].err[3].count();
		size_t cnt_other  = error_acc[i].err[4].count();
		size_t cnt_q      = error_acc[i].err[5].count();
		double min_lq     = error_acc[i].err[1].min();
		double min_gth    = error_acc[i].err[2].min();
		double min_power  = error_acc[i].err[3].min();
		double min_other  = error_acc[i].err[4].min();
		double min_q      = error_acc[i].err[5].min();
		double max_lq     = error_acc[i].err[1].max();
		double max_gth    = error_acc[i].err[2].max();
		double max_power  = error_acc[i].err[3].max();
		double max_other  = error_acc[i].err[4].max();
		double max_q      = error_acc[i].err[5].max();
